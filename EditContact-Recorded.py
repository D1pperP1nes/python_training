...
class EditContact(unittest.TestCase):
    ...
    def test_edit_contact(self):
        ...
        wd.find_element_by_name("title").send_keys("sometitle")
        wd.find_element_by_name("address").click()
        wd.find_element_by_name("address").clear()
        wd.find_element_by_name("address").send_keys("Gorky Street")
        wd.find_element_by_name("home").click()
        wd.find_element_by_name("home").clear()
        wd.find_element_by_name("home").send_keys("4627799")
        wd.find_element_by_name("email").click()
        wd.find_element_by_name("email").clear()
        wd.find_element_by_name("email").send_keys("John@microsoft.com")
        wd.find_element_by_name("bday").click()
        Select(wd.find_element_by_name("bday")).select_by_visible_text("2")
        wd.find_element_by_css_selector("option[value=\"2\"]").click()
        ...
        wd.find_element_by_name("address2").send_keys("Tolstoy Street")
        wd.find_element_by_name("phone2").click()
        wd.find_element_by_name("phone2").clear()
        wd.find_element_by_name("phone2").send_keys("4665545")
